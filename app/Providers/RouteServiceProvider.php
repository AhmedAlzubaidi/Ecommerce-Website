...
class RouteServiceProvider extends ServiceProvider
{
    ...
    protected function mapApiRoutes()
    {
        Route::group([
                ...
                require base_path('routes/api/product.php'); // * also contains product options routes
                require base_path('routes/api/country.php'); // * also contains city routes
                require base_path('routes/api/order.php');
                require base_path('routes/api/role.php');
                require base_path('routes/api/privilege.php');
